        ...
        <table className="table">
          ...
          <tbody>
            {booksList
              .filter((book) => {
                if (priceRange === "10-20")
                  return book.rentPerDay >= 10 && book.rentPerDay <= 20;
                else if (priceRange === "20-25")
                  return book.rentPerDay >= 20 && book.rentPerDay <= 25;
                else if (priceRange === "25-30")
                  return book.rentPerDay >= 25 && book.rentPerDay <= 30;
                else return book.rentPerDay >= 30;
              })
              .map((book, index) => (
                <tr key={book.id}>
                  <td>{index + 1}</td>
